...
export default function Character(){
    ...
    const responseLisa = 'You picked Lisa!! Bravo.';
    const responseBart = 'You picked Bart.. You rebel.'
   ...
   const bartSimpson = {
    ...
    const[character, setCharacter] = useState(lisaSimpson);
    const[reply, setReply] = useState('You didnt select anything!')
